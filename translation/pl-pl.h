...
static char const * const pl_pl[]={
	...
	[T_HELP_SLE4442_NEW_PSC_FLAG]="New Programmable Security Code (PSC) flag",
    	[T_HELP_UART_GPS]="Dekoder GPS (NMEA)",
	[T_HELP_UART_BRIDGE]="Tryb UART bridge",
	[T_HELP_GCMD_W]="onboard power supply with programmable fuse",
	[T_HELP_GCMD_W_DISABLE]="Disable onboard power supply",
	[T_HELP_GCMD_W_ENABLE]="Włącz wbudowane zasilanie, pokaż menu konfiguracyjner",
	...
	[T_HELP_SYS_MODE]="Pokaż specyficzne dla trybu komendy i pomoc",
	[T_HELP_SYS_HELP]="Jak używać systemu pomocy",
	...
	[T_HELP_VADC]="zmierz napięcie na pinach We/Wy",
	[T_HELP_VADC_SINGLE]="Pomiar prosty",
